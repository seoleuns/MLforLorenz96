# -*- coding: utf-8 -*-
#
# LAFDDIM Main Cycling Code generated by Seoleun Shin (KRISS), April, 2025
#
#---------------------------------------------------------------------------------
#
import os, sys
...
def cycles(model, ini_loader, data_loader, nu_loader, epoch, metric, config, confignu, clean_data, clean_data_nu, mode='Test'):
    ...
    if mode == 'test': # save the prediction result to file
        ...
        # Save data
        with open('newtest_twolayer_data_x40_multiddim.pkl', 'wb') as f:
...
def main(params: dict):
    ...
    #for sample_strategy, sample_steps in [('ddpm', 20)]:
